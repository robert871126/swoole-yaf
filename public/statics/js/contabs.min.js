...
$(function() {
	...
	function n() {
		...
		if ($(".J_menuTab").each(function() {
			return $(this).data("id").split("?")[0] == t.split("?")[0] ? ($(this).hasClass("active") || ($(this).addClass("active").siblings(".J_menuTab").removeClass("active"), e(this), $(".J_mainContent .J_iframe").each(function() {
				return $(this).data("id").split("?")[0] == t.split("?")[0] ? ($(this).show().siblings(".J_iframe").hide(),$(this).attr("src", t), !1) : void 0
			})), _n = !1, !1) : void 0
		}), _n) {
			var s = '<a href="javascript:;" class="active J_menuTab" data-id="' + t + '">' + i + ' <i class="fa fa-times-circle"></i></a>';
			$(".J_menuTab").removeClass("active");
			var r = '<iframe class="J_iframe" id="iframe' + a + '" name="iframe" width="100%" height="100%" src="' + t + '" frameborder="0" data-id="' + t + '" seamless></iframe>';
			_index++;
			$(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(r);
			var o = layer.load();
			$(".J_mainContent iframe:visible").load(function() {
				layer.close(o);
				$("#iframe" + a).contents().find("body").on("click", ".J_menuItem", n)
			}),
	...
	$("#iframe").load(function () {
		$("#iframe").contents().find("body").on("click", ".J_menuItem", n);
	}),
